<div align="center">
  ...
  *Покращте свою подорож вивчення мов з Honyomi!*
  ...
  [![UI](https://img.shields.io/badge/UI-Material%203-6750A4?logo=material-design&logoColor=white)](https://m3.material.io/)
...
Honyomi — це сучасний додаток для читання PDF документів, спеціально розроблений для тих, хто вивчає мови. Створений на Flutter з використанням системи дизайну Google Material 3, він забезпечує безшовний досвід читання з красивими, доступними інтерфейсами, одночасно допомагаючи вам створювати власний словник.
...
### 🎨 Сучасний інтерфейс
- **Material 3 Design**: Красивий, сучасний інтерфейс відповідно до найновішої системи дизайну Google
- **Типографіка Inter**: Професійна шрифтова сім'я Inter для винятково високої читабельності
- **Динамічні теми**: Адаптивні кольорові схеми Material You зі світлим і темним режимами
- **Navigation Rail**: Ефективна навігація з компонентами Material 3
- **Адаптивний макет**: Адаптивний інтерфейс для різних розмірів екрана та орієнтацій
- **Доступність**: Вбудовані функції доступності відповідно до керівних принципів Material Design
...
- **Material 3**: Система дизайну Google з динамічними темами
- **Syncfusion PDF Viewer**: Розширене відтворення PDF
- **Provider**: Управління станом
- **Google Fonts (Inter)**: Професійна типографіка
- **intl_utils**: Професійна інтернаціоналізація з ARB-файлами
...
### Архітектура
- **Material 3 Design Pattern**: Чисті, доступні та красиві інтерфейси
- **Provider State Management**: Реактивні оновлення UI з правильним розділенням відповідальностей
- **Професійна локалізація**: Переклади на основі ARB-файлів з метаданими
- **Модульний дизайн компонентів**: Легко розширювати та підтримувати з компонентами Material 3
